...
export default {
    ...
    methods: {
        ...
        batchDeleteRelation(val) {
            ...
            this.$http({
                url: "/product/attrattrgrouprelation/attr/relation/delete",
                method: "delete",
        ...
        submitAddRealtion() {
            ...
            if (this.innerdataListSelections.length > 0) {
                ...
                this.$http({
                    url: "/product/attrattrgrouprelation/attr/relation",
                    method: "post",
                    data: this.$http.adornData(postData, false)
                }).then(({data}) => {
                    if (data.code === 0) {
        ...
        init(id) {
            ...
            this.visible = true;
            this.$http({
                url: "/product/attrgroup/" + this.attrGroupId + "/attr/relation",
                method: "get",
        ...
        getDataList() {
            ...
            this.$http({
                url: "/product/attrgroup/" + this.attrGroupId + "/noattr/relation",
                method: "get",
                params: this.$http.adornParams({
                    page: this.pageIndex,
                    limit: this.pageSize,
