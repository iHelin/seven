<template>
    <el-row :gutter="20">
        <el-col :span="6">
            <category-tree @node-click="handleTreeNodeClick"></category-tree>
        </el-col>
        <el-col :span="18">
...
<script>
import CategoryTree from 'src/views/common/category'
...
export default {
    ...
    methods: {
        ...
        getDataList() {
            ...
            this.$http({
                url: `/product/attrgroup/list/${this.catId}`,
                method: 'get',
                params: {
                    'page': this.pageIndex,
                    'limit': this.pageSize,
