    ...
    <div class="mod-config">
        ...
        <el-table
            ...
            <el-table-column
                ...
                <template slot-scope="scope">
                    <el-switch
                        @change="handleChangeShowStatus(scope.row)"
                        :active-value="1"
                        :inactive-value="0"
...
import CategoryCascader from 'src/views/common/category-cascader'
...
export default {
    ...
    methods: {
        ...
        getCateRelation() {
            this.$http({
                url: "/product/categorybrandrelation/catalog/list",
                method: "get",
