<template>
  <el-dialog
    ...
    <el-form-item label="±ä»¯µÄÖµ" prop="changeCount">
      <el-input v-model="dataForm.changeCount" placeholder="±ä»¯µÄÖµ"></el-input>
    </el-form-item>
    ...
    data () {
      return {
        ...
        dataRule: {
          ...
          changeCount: [
            { required: true, message: '±ä»¯µÄÖµ不能为空', trigger: 'blur' }
          ],
          note: [
