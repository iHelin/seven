  ...
  <div class="mod-config">
    ...
    <el-table
      ...
      <el-table-column
        ...
        header-align="center"
        align="center"
        label="ÊÇ·ñÐèÒª¼ìË÷[0-²»ÐèÒª£¬1-ÐèÒª]">
      </el-table-column>
      <el-table-column
        prop="icon"
        header-align="center"
      ...
      <el-table-column
        ...
        header-align="center"
        align="center"
        label="¿ÉÑ¡ÖµÁÐ±í[ÓÃ¶ººÅ·Ö¸ô]">
      </el-table-column>
      <el-table-column
        prop="attrType"
        header-align="center"
        align="center"
        label="ÊôÐÔÀàÐÍ[0-ÏúÊÛÊôÐÔ£¬1-»ù±¾ÊôÐÔ£¬2-¼ÈÊÇÏúÊÛÊôÐÔÓÖÊÇ»ù±¾ÊôÐÔ]">
      </el-table-column>
      <el-table-column
        prop="enable"
        header-align="center"
      ...
      <el-table-column
        ...
        header-align="center"
        align="center"
        label="¿ìËÙÕ¹Ê¾¡¾ÊÇ·ñÕ¹Ê¾ÔÚ½éÉÜÉÏ£»0-·ñ 1-ÊÇ¡¿£¬ÔÚskuÖÐÈÔÈ»¿ÉÒÔµ÷Õû">
      </el-table-column>
      <el-table-column
        fixed="right"
        header-align="center"
